  ...
  run: async (client, message) => {
    ...
    if (message.content.match(mention)) {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `> <:heart:1415227573197078571> **Hey ${message.author}**,\n> <:dot:1414557898738237440> **Prefix For This Server\`${prefix}\`**\n\n- ___Type ${prefix}help for more information.___`,
        )
      ...
      const meko3 = new EmbedBuilder()
        ...
        .setImage(client.config.links.arrkiii)
        .setDescription(
          `>>> ***<:inv:1414558766912897024> Invite Links: [Click Me](${client.config.links.invite})\n<:support:1415227546009604157> Support Server Link [Click Me](${client.config.links.support})\n<:privacy:1414557961254342666> Privacy Policy Link: [Click Me](https://github.com/edctrmiktg/aarii-privacy-policy)\n<:topgg:1414557313884225651> Vote Link: [Click Me](https://top.gg/bot/1033496708992204840/vote)***`,
        );
