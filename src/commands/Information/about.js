  ...
  execute: async (message, args, client, prefix) => {
    try {
      ...
      const homeEmbed = new EmbedBuilder()
        ...
        .setDescription(
          `_<:dot:1414557898738237440> <a:Playing:1414588003191488522> **Check** [Website!](https://arrkiii.netlify.app)\n` +
            `<:dot:1414557898738237440> **Join** [Support](${client.config.links.support}) & Get **Nop**!_\n\n` +
